 ...
 * ANIM-ANCHOR-001
 */
export function resolveAnchorPosition(clip, anchorName, frame) {
    ...
    if (frame <= sorted[0].frame)
        return { x: sorted[0].pos.x, y: sorted[0].pos.y };
 ...
 * ANIM-ANCHOR-002
 */
export function detectCircularAttachment(entities, proposedEntityId, proposedParentId) {
 ...
 * ANIM-ANCHOR-003
 */
export function resolveOcclusionOrder(anchorY, parentHalfHeight) {
    return anchorY > parentHalfHeight ? 'in-front' : 'behind';
}
//# sourceMappingURL=animation-anchor.js.map
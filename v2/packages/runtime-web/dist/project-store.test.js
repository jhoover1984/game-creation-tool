...
describe('ProjectStore', () => {
    ...
    it('load rejects JSON missing required top-level fields', () => {
        ...
        assert.throws(() => store.loadFromJson(invalid), /Invalid project JSON/);
    });
    ...
    it('load rejects quest graph with missing edge endpoint', () => {
        ...
        assert.throws(() => store.loadFromJson(invalid), /Invalid project JSON \(semantic\):/);
    });
    it('load rejects quest graph with no start node', () => {
        ...
        assert.throws(() => store.loadFromJson(invalid), /QUEST_START_NODE_MISSING/);
    });
    it('load rejects quest graph with multiple start nodes', () => {
        ...
        assert.throws(() => store.loadFromJson(invalid), /QUEST_START_NODE_MULTIPLE/);
    });
...
//# sourceMappingURL=project-store.test.js.map
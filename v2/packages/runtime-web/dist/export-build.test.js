...
describe('EXPORT-BUILD-001: buildDeterministicExport', () => {
    ...
    it('returns deterministic artifact ordering and provenance artifact', () => {
        ...
        assert.deepEqual(report.artifacts.map((a) => a.path), ['export/manifest.json', 'export/project.json', 'export/provenance.json']);
...
//# sourceMappingURL=export-build.test.js.map
...
// -- Animation anchor commands (ANIM-ANCHOR-001) --
...
// -- Entity slot commands (ANIM-ANCHOR-002/003) --
...
export type AnyCommand =
  ...
  | DeleteEntityCommand
  | MoveEntityCommand
  | UpdateEntityVisualCommand
  | RenameEntityCommand
  | SetEntitySpeedCommand
  | SetTileCommand
  | PlaytestEnterCommand
  | PlaytestExitCommand
  | PlaytestPauseCommand
  | PlaytestResumeCommand
  | BehaviorRowAddCommand
  | BehaviorRowRemoveCommand
  | BehaviorRowUpdateCommand
  | ApplyEffectPresetCommand
  | SetEffectFieldCouplingCommand
  | AnimationAnchorAddCommand
  | AnimationAnchorMoveCommand
  | AnimationAnchorRemoveCommand
  | EntitySlotAttachCommand
  | EntitySlotDetachCommand
  | EntitySlotSetOcclusionCommand;

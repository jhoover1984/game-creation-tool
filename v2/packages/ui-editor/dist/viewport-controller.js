...
export class ViewportController {
     ...
     */
    fitToMap(containerWidth, containerHeight, mapWidth, mapHeight, margin = 0) {
        ...
        const fitZoom = Math.min(effectiveWidth / mapWidth, effectiveHeight / mapHeight, VIEWPORT_MAX_ZOOM);

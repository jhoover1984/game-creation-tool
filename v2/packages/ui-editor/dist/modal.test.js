...
function makeFocusable() {
    const el = { focus: () => { el.wasFocused = true; }, wasFocused: false };
    return el;
}
function makeButton(id) {
    ...
    const el = {
        ...
        textContent: '',
        dataset: {},
        hasAttribute: (name) => name === 'disabled' ? el.disabled : false,
...
function makeOverlay() {
    ...
    const overlay = {
        ...
        fireKeydown: (key, opts = {}) => {
            const evt = { key, preventDefault: () => undefined, shiftKey: false, ...opts };

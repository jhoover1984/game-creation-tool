...
describe('UI-VIEWPORT-001: ViewportController', () => {
    ...
    describe('handleWheel', () => {
        ...
        it('adjusts pan to keep world point under cursor fixed when zooming off-center', () => {
            ...
            assert.ok(Math.abs(worldXBefore - worldXAfter) < 0.001, `world point must stay fixed under cursor: before=${worldXBefore}, after=${worldXAfter}`);
        });
    });
    describe('pan', () => {
...
//# sourceMappingURL=viewport-controller.test.js.map